 ...
 * 
 * @param chain the blockchain representing the votes
 * @param num_candidates number of candidates in the election
 * @param candidates names of each candidate
 */
...
/**
 * @brief Election functionality. Repeatedly ask for voters name and their vote. 
 * Call blockchain functions as needed.
 * 
 * @param chain the blockchain representing the votes
 * @param num_candidates number of candidates running
 * @param candidates names of the candidates
 */
...
/**
 * @brief Sets up the election and runs the election functions.
 * 
 * @return int 
 */
int main(void){
